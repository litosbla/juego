...
window.onload = function (){
    const container = body.querySelector(".container-registro")
    const divspawn = body .querySelector(".spawn-bib")
    ...
    for( let key in did){
        ...
        <div class="caja">
                <div class="cuadro">
                    <img src=${did[key].imagen} >
                    <div class="cuadro-texto">
                        <span class="texto-nombre">${key}</span>
